def zkextendfmt(self):
    ...
    desc = ": +"+hex(int('99', 16)+plus1).lstrip('0x') + \
        ", +"+hex(int('b1', 16)+plus2).lstrip("0x")
    self.data_seq1 = hex(
        int(data_seq[0], 16) + int('99', 16) + plus1).lstrip("0x")
    self.data_seq2 = hex(
        int(data_seq[1], 16) + int('b1', 16) + plus2).lstrip("0x")
    ...
    data = "0b00"+self.data_seq1+self.data_seq2 + \
        self.id_com+counter+"007e457874656e64466d7400"
